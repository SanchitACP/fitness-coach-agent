...
Lives under adk_app/ so `adk web adk_app` discovers exactly one agent (a clean,
single-entry app list for the demo). The repo-root agent.py re-exports
`root_agent` from here for the CLI (main.py) and the tests.
"""
